...
search_terms = ["Generative AI", "Gen AI"]
...
bad_words = ["US Citizen","USA Citizen","No C2C", "No Corp2Corp", "CNC"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
